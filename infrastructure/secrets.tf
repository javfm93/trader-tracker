module "bitget-api-key-secret" {
  source = "git::git@github.com:javfm93/infrastructure-aws-terraform.git//src/storage/use-cases/create-secure-parameter"
...
module "cloudfront-id-parameter" {
  source = "git::git@github.com:javfm93/infrastructure-aws-terraform.git//src/storage/use-cases/create-parameter"
